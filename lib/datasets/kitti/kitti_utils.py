...
class Calibration(object):
    ...
    def rect_to_img(self, pts_rect, P2):
        """
        :param pts_rect: (N, 3)
        :return pts_img: (N, 2)
        """
    ...
    def corners3d_to_img_boxes(self, corners3d, calib_l):
        """
        ...
        img_pts = np.matmul(corners3d_hom, calib_l.T)  # (N, 8, 3)
    ...
    def alpha2ry(self, alpha, u):
        ...
        if torch.is_tensor(alpha):
            ry = alpha + torch.atan2(u - self.cu, torch.tensor(self.fu).cuda())
